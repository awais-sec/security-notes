# Network Forensics — Assignments

## Contents

| File | Covers |
|---|---|
| [01-ctf-challenges.md](01-ctf-challenges.md) | Three CTF-style network forensics challenges: DNS TXT beaconing, HTTP tracking-pixel exfiltration, and an ICMP/XOR covert channel, each with Wireshark methodology, IOCs, and recovered flags |
